...
class AttentionModel(torch.nn.Module):
    def __init__(self, batch_size, output_size, hidden_size, vocab_size, embedding_length, weights):
        ...
        self.labelA = nn.Linear(hidden_size, output_size)
        self.labelB = nn.Linear(hidden_size, output_size)
    ...
    def forward(self, input_sentenceA, input_sentenceB, batch_size=None):
        ...
        logitsA = self.labelA(fin_outputA)
        logitsB = self.labelB(fin_outputB)
